...
- (UITableView *)tableView
{
    if (!_tableView) {
        ...
        _tableView.frame = CGRectMake(0, DCTopNavH, tableViewH, self.view.bounds.size.height);
...
- (UICollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        _collectionView.frame = CGRectMake(tableViewH + 5, DCTopNavH, ScreenW - tableViewH - DCMargin, self.view.bounds.size.height);
        //注册Cell
...
//    self.navigationItem.rightBarButtonItems = @[negativeSpacer, backButton];
    ...
    _topSearchView.frame = CGRectMake(50, 6, ScreenW - 50, 32);

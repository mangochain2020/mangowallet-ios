...
- (void)setUpUI
{
    ...
    linkView.backgroundColor = [UIColor groupTableViewBackgroundColor];
...
- (void)setYouLikeItem:(DCRecommendItem *)youLikeItem
{
    ...
    _priceLabel.text = [NSString stringWithFormat:@"%@%.2f",[CreateAll GetCurrentCurrency].symbol,([[CreateAll GetCurrentCurrency].price doubleValue] * youLikeItem.price.doubleValue)];

...
//    
    if (self.tag == 1022) {
        PlaceholderLabel.frame  =CGRectMake(ScreenW - 222, top
                                            ,100, hegiht);
...
//    self.attributedText = attributedString;
    ...
    if (self.tag == 1012) {
    size =  [self.text boundingRectWithSize:CGSizeMake(ScreenW - A, 999999999) options:NSStringDrawingUsesLineFragmentOrigin
                                                                 attributes:@{
    ...
    {
        size =  [self.text boundingRectWithSize:CGSizeMake(ScreenW - B, 999999999) options:NSStringDrawingUsesLineFragmentOrigin
                                     attributes:@{
                                                  NSFontAttributeName:[UIFont systemFontOfSize:15],
                                                  }context:nil].size;
    }

 ...
 */
+ (void)showUpdateAlertWithVersion:(NSString *)version Descriptions:(NSArray *)descriptions andDownUrl:(NSString *)url
{
    ...
    SELUpdateAlert *updateAlert = [[SELUpdateAlert alloc]initVersion:version description:description andDownUrl:url];
 ...
 */
+ (void)showUpdateAlertWithVersion:(NSString *)version Description:(NSString *)description andDownUrl:(NSString *)url
{
    SELUpdateAlert *updateAlert = [[SELUpdateAlert alloc]initVersion:version description:description andDownUrl:url];
    [[UIApplication sharedApplication].delegate.window addSubview:updateAlert];
}

- (instancetype)initVersion:(NSString *)version description:(NSString *)description andDownUrl:(NSString *)url
{
    self = [super init];
    if (self) {
...
- (void)_setupUI
{
    ...
    versionLabel.text = [NSString stringWithFormat:@"%@ V%@",NSLocalizedString(@"发现新版本", nil),self.version];
...
- (void)updateVersion
{
    ...
    [self dismissAlert];
    if(@available(iOS 10.0, *) && self.url.length > 0) {

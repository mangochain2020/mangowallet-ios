...
{
    if (!_buttonLeft) {
        CGFloat leftX = STMarginBig-15;
        CGFloat leftY = STMarginSmall;
        CGFloat leftW = STControlSystemHeight+30;
...
{
    if (!_buttonRight) {
        CGFloat rightW = STControlSystemHeight+30;
        CGFloat rightH = STControlSystemHeight - STMargin;
        CGFloat rightX = ScreenWidth - rightW - STMarginBig+15;

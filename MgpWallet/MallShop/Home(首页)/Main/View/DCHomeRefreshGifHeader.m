...
- (void)prepare{
    ...
    // 设置文字
    [self setTitle:NSLocalizedString(@"下拉松手刷新", nil) forState:MJRefreshStateIdle];
    [self setTitle:NSLocalizedString(@"松手刷新数据", nil) forState:MJRefreshStatePulling];
    [self setTitle:NSLocalizedString(@"帮您更新数据", nil) forState:MJRefreshStateRefreshing];

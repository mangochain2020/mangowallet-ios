...
@implementation LHCurrencyModel


-(void)vailidateCurrencyModel{
    self.sort = self.sort;
    self.name = VALIDATE_STRING(self.name);
    self.symbol = VALIDATE_STRING(self.symbol);
    self.price = VALIDATE_STRING(self.price);
    self.symbolName = VALIDATE_STRING(self.symbolName);
...
- (void)encodeWithCoder:(NSCoder *)coder
{
    ...
    Ivar *ivars = class_copyIvarList([LHCurrencyModel class], &count);

...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.nfImageView.contentMode = UIViewContentModeCenter;
...
//        [weakSelf restoreRootViewController:secondNavigationController];
        if ([CreateAll GetWalletNameArray].count <= 0) {
            ...
            [self restoreRootViewController:csVC];
...
//        UIViewController *secondNavigationController = [[CYLBaseNavigationController alloc]
//        initWithRootViewController:[[CreateAccountVC alloc] init]];
//        [self restoreRootViewController:secondNavigationController];
        if ([CreateAll GetWalletNameArray].count <= 0) {
            UIViewController *vc = [[CYLBaseNavigationController alloc]
            initWithRootViewController:[[CreateAccountVC alloc] init]];
            [self restoreRootViewController:vc];

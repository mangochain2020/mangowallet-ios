...
- (void)initUI {
    ...
    [_timeLineView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.left.equalTo(self.stockScrollView.contentView);
        make.height.equalTo(self.stockScrollView.contentView).multipliedBy([YYStockVariable lineMainViewRadio]);
        make.width.equalTo(self.stockScrollView);
    ...
    [_volumeView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.equalTo(self.stockScrollView.contentView).multipliedBy(1-[YYStockVariable lineMainViewRadio]);
    }];
}

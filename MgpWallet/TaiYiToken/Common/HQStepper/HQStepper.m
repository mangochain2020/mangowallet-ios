...
- (void)commonInit {
    ...
    self.valueTextField.text = [NSString stringWithFormat:@"%.2f",[_currentValue floatValue]];//[self.currentValue stringValue];
...
- (void)setCurrentValue:(NSNumber *)value {
    ...
    self.valueTextField.text = [NSString stringWithFormat:@"%.2f",[_currentValue floatValue]];//[_currentValue stringValue];
